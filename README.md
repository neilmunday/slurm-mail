...
7. [E-mail Retries](#e-mail-retries)
8. [E-mail Headers](#e-mail-headers)
9. [E-mail Domain](#e-mail-domain)
10. [Customising E-mails](#customising-e-mails)
11. [Validating E-mails](#validating-e-mails)
...
If you want to automatically add a domain for e-mails generated by Slurm-Mail you can define a domain using the `mailDomain` option in `slurm-mail.conf`.

Slurm-Mail wil only append the chosen domain if there is no `@` in the value given to Slurm's `--mail-user` job parameter.
...
* [@hakasapl](https://www.github.com/hakasapl)
...
* [Jah-yee (@Jah-yee)](https://github.com/Jah-yee)
* [Kasper Skytte Andersen (@KasperSkytte)](https://www.github.com/KasperSkytte)
* [@langefa](https://www.github.com/langefa)
* [@lsterck](https://github.com/lsterck)
* [@mamiller615](https://www.github.com/mamiller615)
...
* [@patbel-pwr](https://www.github.com/patbel-pwr)
* [@pavalenta](https://www.github.com/pavalenta)
* [@rzegson](https://www.github.com/rzegson)
* [@sdx23](https://www.github.com/sdx23)
* [Simon Feltman (@sfeltman)](https://www.github.com/sfeltman)
* [Thanasis Georgiou (@thgeorgiou)](https://www.github.com/thgeorgiou)
* [@walee-1](https://github.com/walee-1)
